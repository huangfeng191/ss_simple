 ...
 * Set Modules
 */
fis.match('/{node_modules,web,static/modules}/**', {
    isMod: true,
 ...
 */
//1、JS Parser
fis.match('/web/**.{js,vue:js}',{
    rExt:'.js',
    isMod:true,
    useSameNameRequire:true,
    parser:fis.plugin('babel-5.x',{})
});
fis.match('{/static/**.js,/web/components/echarts.min.js}', {
    parser: null,
    isMod: false
});
//2、添加css和image加载支持
...
//3、less Parser
fis.match('{/static/css/*.less,/web/**.{css,less}}', {
    parser: 'less2',
    rExt: '.css',
