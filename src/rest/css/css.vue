<template>
    <div id="css">
        ...
        <p>------------------------------------↓ style----</p>
        <div class="simple" :style="styleObject">
            样式对象,如果是复合属性需要用驼峰命名法
        </div>
        <div class="simple" :style="{backgroundColor:'#444'}">
            对象模式
        </div>
        <div class="simple" :style="[{backgroundColor:'#666'},1!=1?{border:'2px red solid'}:{border:'2px blue solid'}]">
            数组模式,对象复合模式
        </div>
    </div>
</template>
