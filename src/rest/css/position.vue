<template>
    <div id="position" style="position:relative">
        <!-- position:absolute 脱离默认文档流，相对浏览器,在无top left 等属性的时候，占据原位置
                      relative：原地脱离（top left ）,保留原位置
                      f
 ...
 -->
        ...
        <div id="a" class="out" style="background-color: green; position:relative; left:110px;top:100px;z-index:12" >
            <div id="aa" class="in" style="">
                1
            </div>
        </div>
        <div id="b" class="out" style="position:absolute;z-index:11;top:250px; ">
            <div id="bb" class="in" style="">
                2
            </div>
        </div>
    </div>
