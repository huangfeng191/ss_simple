      ...
      types: [
        {
          value: "CrudColumns",
          label: "CrudColumns",
          template: '{ "field": "${1:sn}","title": "${0:nm}", "width": 100,$?param1? },',
...

        {
          ...
          param: [
            {
              k: "2",
              v: [
                { k: "replace", v: { c: "combo", d: "datetime", a: "textarea", u: "upload", t: "text", f: "text" } }
              ]
            },
          ...
          deakTemplateLikeArray: function(a, self) {
            ...
            ids.forEach(function(v, i) {
              ...
              group += Number(v);
              if (i == ids.length - 1 || group + ids[i + 1] > 3 || (o[i] && o[i].br)) {
                a[i] = a[i].replace(/},$/, "},],");
                group = 0;
              }
            });
...

        {
          value: "CrudProp",
          label: "CrudProp",
          template: '{ "Field": "${1}", "Name": "${0}", ShowType: "${2:text}", Ext: "$?param1?",DataType: "$?dataType:String?" },',
...

        {
         ...
         mDParamHandleBefore:function({param,v,aRow}){
              ...
              if(param=="param1" && aRow.length>2 && aRow[2]=="d"){
                 ...
                 v='Ext: "{Format:"' + (v||"yyyy-MM-dd") + '"}", Value: new Date().FormatString("' + (v||"yyyy-MM-dd") + '")';
                 
              }else if(param=="param1" && aRow.length>2 && aRow[2]=="c"){
                 v=' Ext: "' + (v||"USER") + '", Source: "'  + (v||"USER") + '", ' 
              }else  if(param=="param1"){
                 v=""
              }
